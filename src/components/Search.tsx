    ...
    <div className="flex w-full justify-center ">
        <form className="flex items-center mt-10 min-w-[400px] w-full max-w-[1000px]   ">
          ...
          <button
            ...
            className="inline-flex shadow-md items-center py-2.5 px-3 ml-2 text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-2 focus:outline-none focus:ring-blue-300  "
          >
            <svg
              aria-hidden="true"
